            ...
            <?php foreach ($data['users'] as $user) : ?>
                <tr>
                    ...
                    <td data-label="Delete">
                        <?= "<a href=" . URL_ROOT . "/users/delete/{$user->id}' class='delete' onclick='return confirm(\"Do you want to delete this record?\")' title='Delete' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>" ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
